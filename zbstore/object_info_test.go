	...
	return []*objectInfoMarshalTest{
		{
			...
			info: &ObjectInfo{
				...
				NARSize:        1228440,
				ContentAddress: nix.RecursiveFileContentAddress(mustParseHash(tb, "sha256:143sdn30fdykpz8gpyw45m9m6m4gz858w9kc6myy7p0v74v5qq4m")),
			},
		},
		{
			name: "OneReference",
			...
			info: &ObjectInfo{
				...
				ContentAddress: nix.RecursiveFileContentAddress(mustParseHash(tb, "sha256:0pikk3c4s55bhh1nzbj2150ksbnsxnvl4xarap58kjp9qv5d4z1k")),
			},
		},
		{
			name: "TwoReferences",
			...
			info: &ObjectInfo{
				...
				ContentAddress: nix.RecursiveFileContentAddress(mustParseHash(tb, "sha256:073lrg7m3rrqbn9wgy7wrf94h77hhhjmnvwhh8vqpnbflsgzb8dk")),
			},
		},
		{
			name: "LineNoise",
